...
class form extends Controller
{
    ...
    public function info($id)
    {
        $patient = DB::table('patient')
            ->leftJoin('c_info','c_info.info_patient_id','patient.patient_id')
        ...
        return view('clinic.form.info',['patient'=>$patient,'type_1'=>$type_1,'type_2'=>$type_2,'m_type'=>$m_type]);
    }
    ...
    public function updateInfo(Request $request, $id)
    {
        ...
        DB::table('c_info')->where('info_patient_id',$id)->update(
            [
                "info_patient_id" => $id,
                "info_type" => $request->get('info_type'),
                "info_date_in" => $request->get('info_date_in'),
    ...
    {
        $patient = DB::table('patient')
            ->leftJoin('c_screen','c_screen.screen_patient_id','patient.patient_id')
            ->where('patient.patient_id', $id)
            ->first();
        $m_type = DB::table('martix_type')->get();
        return view('clinic.form.screen',['patient'=>$patient,'m_type'=>$m_type]);
    }
    ...
    public function updateScreen(Request $request, $id)
    {
        ...
        DB::table('c_screen')->where('screen_patient_id',$id)->update(
            [
                "screen_patient_id" => $id,
                "screen_date" => $request->get('screen_date'),
                "screen_place" => $request->get('screen_place'),
    ...
    {
        $patient = DB::table('patient')
            ->leftJoin('c_depress','c_depress.dep_patient_id','patient.patient_id')
            ->where('patient.patient_id', $id)
            ->first();
        return view('clinic.form.depress',['patient'=>$patient]);
    }
    ...
    public function Q9($id)
    {
        $patient = DB::table('patient')
            ...
            ->where('patient.patient_id', $id)
            ->first();
        return view('clinic.form.9Q',['patient'=>$patient]);
    }
    ...
    public function Q8($id)
    {
        $patient = DB::table('patient')
            ...
            ->where('patient.patient_id', $id)
            ->first();
        return view('clinic.form.8Q',['patient'=>$patient]);
    }
    ...
    public function add9Q(Request $request, $id)
    {
        ...
        DB::table('c_depress')->where('dep_patient_id',$id)->update(
            [
                "dep_9q" => $q9,
            ]
        );
        $patient = DB::table('patient')->where('patient_id', $id)->first();
        return redirect()->route('form.depress', ['id' => $id])->with('success','บันทึกข้อมูลประเมินซึมเศร้า 9Q : HN: '.$patient->patient_hn." ".$patient->patient_name);
    }
