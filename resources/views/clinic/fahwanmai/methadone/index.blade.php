                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 text-end" style="margin-top: 1rem;">
                            <div class="btn-group" role="group">
                                <a href="{{ route('met.list',base64_encode(0)) }}" class="btn btn-sm btn-primary">
                                    <i class="fa-solid fa-list"></i>
                                    ทั้งหมด
                                </a>
                                <a href="{{ route('met.list',base64_encode(1)) }}" class="btn btn-sm btn-primary">
                                    <i class="fa-solid fa-spinner fa-spin"></i>
                                    กำลังบำบัด
                                </a>
                                <a href="{{ route('met.list',base64_encode(3)) }}" class="btn btn-sm btn-primary">
                                    <i class="fa-regular fa-face-smile-beam"></i>
                                    รักษาหายขาด
                                </a>
                                <a href="{{ route('met.list',base64_encode(4)) }}" class="btn btn-sm btn-primary">
