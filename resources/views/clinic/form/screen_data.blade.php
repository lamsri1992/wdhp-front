<form action="{{ route('methadone.updateScreen',$patient->patient_id) }}">
    <div class="row">
        <div class="form-group col-md-6">
            ...
            <div class="input-group mb-2">
                <input type="text" name="screen_date" class="form-control basicDate" placeholder="เลือกวันที่"
                    value="{{ $patient->screen_date }}" readonly>
        ...
        <div class="form-group col-md-6">
            ...
            <div class="input-group mb-2">
                <input type="text" name="screen_place" class="form-control" placeholder="ระบุสถานที่"
                    value="{{ $patient->screen_place }}">
                <div class="input-group-text"><i class="fa-solid fa-home"></i></div>
            </div>
        </div>
        <div class="form-group col-md-12">
            <label for="">ชนิดของสารเสพติดที่ใช้</label>
            <small class="text-danger">* สามารถเพิ่มตัวเลือกเองได้ *</small>
            <select class="basic-multiple" name="screen_drug[]" multiple="multiple">
                @php $drug = explode(',',$patient->screen_drug); @endphp
            ...
            <table class="table table-borderless table-striped">
                    ...
                    <tr class="text-center">
                        <th colspan="2">
                            ...
                            <select class="form-control basic-select2" name="screen_primary">
                                ...
                                @foreach ($m_type as $res)
                                <option value="{{ $res->m_type_id }}"
                                    {{ $patient->screen_primary == $res->m_type_id ? 'selected' : '' }}>
                                    {{ $res->m_type_name }}
                                </option>
                                @endforeach
                            </select>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <select name="screen_1" class="form-select">
                                ...
                                <option value="0"
                                    {{ $patient->screen_1 === '0' ? 'selected' : '' }}>
                                    ไม่เคย
                                </option>
                                <option value="2"
                                    {{ $patient->screen_1 === '2' ? 'selected' : '' }}>
                                    1-2 ครั้ง
                                </option>
                                <option value="3"
                                    {{ $patient->screen_1 === '3' ? 'selected' : '' }}>
                                    เดือนละ 1-3 ครั้ง
                                </option>
                                <option value="4"
                                    {{ $patient->screen_1 === '4' ? 'selected' : '' }}>
                                    สัปดาห์ละ 1-4 ครั้ง
                                </option>
                                <option value="6"
                                    {{ $patient->screen_1 === '6' ? 'selected' : '' }}>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="screen_2" class="form-select">
                                <option value="">กรุณาระบุ</option>
                                <option value="0"
                                    {{ $patient->screen_2 === '0' ? 'selected' : '' }}>
                                    ไม่เคย
                                </option>
                                <option value="3"
                                    {{ $patient->screen_2 === '3' ? 'selected' : '' }}>
                                    1-2 ครั้ง
                                </option>
                                <option value="4"
                                    {{ $patient->screen_2 === '4' ? 'selected' : '' }}>
                                    เดือนละ 1-3 ครั้ง
                                </option>
                                <option value="5"
                                    {{ $patient->screen_2 === '5' ? 'selected' : '' }}>
                                    สัปดาห์ละ 1-4 ครั้ง
                                </option>
                                <option value="6"
                                    {{ $patient->screen_2 === '6' ? 'selected' : '' }}>
                                    เกือบทุกวัน (สัปดาห์ละ 5-7 วัน)
                                </option>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="screen_3" class="form-select">
                                <option value="">กรุณาระบุ</option>
                                <option value="0"
                                    {{ $patient->screen_3 === '0' ? 'selected' : '' }}>
                                    ไม่เคย
                                </option>
                                <option value="4"
                                    {{ $patient->screen_3 === '4' ? 'selected' : '' }}>
                                    1-2 ครั้ง
                                </option>
                                <option value="5"
                                    {{ $patient->screen_3 === '5' ? 'selected' : '' }}>
                                    เดือนละ 1-3 ครั้ง
                                </option>
                                <option value="6"
                                    {{ $patient->screen_3 === '6' ? 'selected' : '' }}>
                                    สัปดาห์ละ 1-4 ครั้ง
                                </option>
                                <option value="7"
                                    {{ $patient->screen_3 === '7' ? 'selected' : '' }}>
                                    เกือบทุกวัน (สัปดาห์ละ 5-7 วัน)
                                </option>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="screen_4" class="form-select">
                                <option value="">กรุณาระบุ</option>
                                <option value="0"
                                    {{ $patient->screen_4 === '0' ? 'selected' : '' }}>
                                    ไม่เคย
                                </option>
                                <option value="5"
                                    {{ $patient->screen_4 === '5' ? 'selected' : '' }}>
                                    1-2 ครั้ง
                                </option>
                                <option value="6"
                                    {{ $patient->screen_4 === '6' ? 'selected' : '' }}>
                                    เดือนละ 1-3 ครั้ง
                                </option>
                                <option value="7"
                                    {{ $patient->screen_4 === '7' ? 'selected' : '' }}>
                                    สัปดาห์ละ 1-4 ครั้ง
                                </option>
                                <option value="8"
                                    {{ $patient->screen_4 === '8' ? 'selected' : '' }}>
                                    เกือบทุกวัน (สัปดาห์ละ 5-7 วัน)
                                </option>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="screen_5" class="form-select">
                                <option value="">กรุณาระบุ</option>
                                <option value="0"
                                    {{ $patient->screen_5 === '0' ? 'selected' : '' }}>
                                    ไม่เคย
                                </option>
                                <option value="3"
                                    {{ $patient->screen_5 === '3' ? 'selected' : '' }}>
                                    เคย แต่ก่อน 3 เดือนที่ผ่านมา
                                </option>
                                <option value="6"
                                    {{ $patient->screen_5 === '6' ? 'selected' : '' }}>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="screen_6" class="form-select">
                                <option value="">กรุณาระบุ</option>
                                <option value="0"
                                    {{ $patient->screen_6 === '0' ? 'selected' : '' }}>
                                    ไม่เคย
                                </option>
                                <option value="3"
                                    {{ $patient->screen_6 === '3' ? 'selected' : '' }}>
                                    เคย แต่ก่อน 3 เดือนที่ผ่านมา
                                </option>
                                <option value="6"
                                    {{ $patient->screen_6 === '6' ? 'selected' : '' }}>
                                    เคย ในช่วง 3 เดือนที่ผ่านมา
                                </option>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="screen_inject" class="form-select">
                                <option value="">กรุณาระบุ</option>
                                <option value="Y"
                                    {{ $patient->screen_inject === 'Y' ? 'selected' : '' }}>
                                    เคย
                                </option>
                                <option value="N"
                                    {{ $patient->screen_inject === 'N' ? 'selected' : '' }}>
                                    ไม่เคย
                                </option>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="screen_inject_note" class="form-select">
                                ...
                                <option value="1"
                                    {{ $patient->screen_inject_note === '1' ? 'selected' : '' }}>
                                    1 ครั้งต่อสัปดาห์ หรือน้อยกว่า 3 วันติดต่อกัน
                                </option>
                                <option value="2"
                                    {{ $patient->screen_inject_note === '2' ? 'selected' : '' }}>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="screen_viewer" class="form-control" value="{{ $patient->screen_viewer }}" readonly>
                        </td>
                    </tr>
                </tbody>
            </table>
    ...
    <div class="form-group text-end">
        <button id="point" type="button" class="btn btn-outline-dark">
            <i class="fa-solid fa-check-to-slot"></i> ระดับคะแนน
        </button>
